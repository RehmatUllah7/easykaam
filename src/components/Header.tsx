...
export const Header = () => {
  ...
  // Navigation items (Safety routes to page now)
  const navItems = [
  ...
  return (
    ...
    >
      <div className="relative flex items-center h-20 px-8 lg:px-20 justify-between mr-0 lg:mr-[70px]">
        ...
        >
          <Link to="/" className="flex items-center gap-4 select-none group ml-0 lg:ml-[70px]">
            <motion.div
              className="relative"
              whileHover={{ rotate: 5 }}
              transition={{ type: "spring", stiffness: 300 }}
        ...
        <motion.button
          ...
          className={`hidden lg:flex items-center gap-2 px-8 py-3 rounded-2xl font-semibold uppercase 
            ...
            relative overflow-hidden group border ${
              isScrolled ? "border-[#8ac9f4]/30 text-white" : "border-white/30 text-black"
            } ${
              isButtonClicked
              ...
              item.href.startsWith("/") ? (
                ...
                <Link
                  ...
                  className={`px-6 py-4 rounded-xl font-semibold text-lg tracking-wide 
                    ...
                    ${isScrolled ? "text-black" : "text-gray-800"} hover:text-black`}
