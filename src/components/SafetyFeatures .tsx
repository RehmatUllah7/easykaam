...
export const SafetyFeatures = () => {
  ...
  const slides = [
    {
      ...
      text: "Keep your home secure with smart locks that provide advanced protection and remote access for your convenience.",
      word: "Excellence",
      icon: Shield,
    },
    {
      ...
      text: "Advanced circuit protection prevents electrical mishaps and keeps your family safe from hazards.",
      word: "Innovation",
      icon: Zap,
    },
    {
      ...
      text: "Stay alert with integrated smoke and fire detectors, ensuring maximum safety in every corner of your home.",
      word: "Future",
      icon: Flame,
    },
  ];
  ...
  const nextSlide = () => { setCurrent((prev) => (prev + 1) % slides.length); setProgress(0); };
  const prevSlide = () => { setCurrent((prev) => (prev - 1 + slides.length) % slides.length); setProgress(0); };
          ...
          <div className="grid lg:grid-cols-2 gap-10 items-start">
                ...
                <div className={`relative overflow-hidden rounded-2xl shadow-lg ${SCREEN_HEIGHT_SMALL} ${SCREEN_HEIGHT_MD} ${SCREEN_HEIGHT_LG}`}>
                  ...
                  <div className="absolute bottom-12 left-0 right-0 p-4 flex justify-between items-center text-white">
                    <div>
                      ...
                      <p className="text-sm opacity-90">Safety Feature</p>
                    </div>
            ...
            <div className="flex flex-col justify-between space-y-5">
              <div>
                ...
                <p className="text-gray-700 leading-relaxed mt-2">{currentSlide.text}</p>
              </div>
                  ...
                  return (
                    <motion.button
                      ...
                      className={`flex flex-col items-center gap-1 px-4 py-3 rounded-lg transition-all duration-300 ${
                        isActive ? "bg-[#8ac9f4] text-white shadow-md" : "bg-gray-100 text-black hover:bg-gray-200"
                      }`}
                    >
                      <SlideIcon className="w-5 h-5" />
                      <span className="font-medium">{slide.word}</span>
                    </motion.button>
                  );
                })}
              </div>
